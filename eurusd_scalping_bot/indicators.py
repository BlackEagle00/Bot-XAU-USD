...
def get_support_resistance(df: pd.DataFrame,
    ...
    """
    # Tolerancia de agrupación relativa al instrumento (sin piso fijo en $:
    # ese piso de $0.5 solo era válido para Oro y rompía pares forex)
    tolerance = atr * SR_CLUSTER_ATR_MULT
    ...
    # 3. Niveles psicológicos cercanos al precio (paso según el instrumento:
    # Oro = 5.0, EURUSD = 0.0050, scalping M5 = 0.0010 — definido en PSYCH_LEVEL_STEP)
