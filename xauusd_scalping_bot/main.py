"""
╔══════════════════════════════════════════════════════════════╗
║         XAU/USD Scalping Bot — Loop Principal               ║
╚══════════════════════════════════════════════════════════════╝
...
def _print_banner():
    sep = "═" * 64
    logger.info(sep)
    logger.info("🤖  XAU/USD (Oro) Scalping Bot  |  by mt5-python")
    logger.info(sep)
...
def _run_cycle():
    ...
    # H1 — contexto macro top-down (sesga el score; con REQUIRE_MACRO_ALIGNMENT=True
    # vetaría scalps contra el H1 fuerte, pero por defecto aquí es solo sesgo suave).
    # Puede faltar si el broker no devolvió el H1; en ese caso se omite el contexto.
    ind_higher  = (
